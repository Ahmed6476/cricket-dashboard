    ...
    const submit = () => {
        if (inputText !== "") {
            axios.post(`${baseUrl}/api/v1/post`, {
                PlayingTeams: inputText,
                FirstBatsman: inputText,
    ...
    return (
        <div style={{ margin: "1rem" }}>
            ...
            {posts.map((eachPost, index) => (
                <Post key={index} name={eachPost.name} email={eachPost.email} PlayingTeams={eachPost.PlayingTeams} Firstbatsman={eachPost.FirstBatsman} SecondBatsman={eachPost.SecondBatsman} Bowler = {eachPost.Bowler}Target = {eachPost.Target}/>
            ))}
